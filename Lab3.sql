...
SELECT NAME,CITY INTO EMPLOYEE_DATAS
FROM EMPLOYEE;


--3Create table Employee_info from Employee with no Data

SELECT * INTO EMPLOYEE_INFOS
FROM EMPLOYEE
WHERE 1 = 2;
